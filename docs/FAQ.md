# Before use
## What is Bitcoin on Tails?

It's first and foremost easy to use, free, quick to setup and very private.

Bitcoin on Tails grew from the question:
> How could everyone keep using Bitcoin easily and safely were it banned?

Because projects like **Bitcoin on Tails** exist and work, the more people who use them, the less likely Bitcoin bans will ever be attempted.
...
Bitcoin on Tails does not make the most secure setup possible yet: offline multi-sig airgapped signing. It is meant for regular or occasional, high privacy transacting not storing National Treasures but a cold storage wallet for savings will come after Beta testers give feedback what they want to see next.

Bitcoin on Tails would be appropriate for up to half a year's expenses. Life savings need multi-signature, offline, airgapped signers.
...
In addition to [Tails' recommendations](https://tails.net/doc/about/requirements/index.en.html), here are some Bitcoin on Tails specific tips for selecting a computer to buy, buy and return, rent or borrow to complete the initial sync as fast as possible:
...
4. **Storage drive type and capacity don't matter.** Tails never uses your computer's storage. You're free to use this computer for other purposes or return it, after removing your Bitcoin on Tails. Bitcoin on Tails would even work with a used PC from eBay with no internal disk!
...
Once you are synced, nearly any computer will be fast enough to stay caught up as long as you use Bitcoin on Tails regularly, especially if you have a [recommended USB stick](https://github.com/BenWestgate/Bails/blob/master/docs/FAQ.md#i-dont-have-a-USB-stick-what-one-should-i-get)

## What type of backup USB stick should I get?

1. Equal size to your primary Bitcoin on Tails helps avoid pruning.
...
NOTE: New versions of Bitcoin on Tails will sync in minutes instead of hours or days thanks to a beta feature called [AssumeUTXO](https://bitcoinops.org/en/topics/assumeutxo/). For extra high value transactions you should wait for the background initial block download to sync.
...
## If I wanted to unplug Bitcoin on Tails and use the computer for another task will the core download just restart where it left off on the next time I log in?
...
## How do I update Bitcoin on Tails?
Click **Applications > Favorites > Bitcoin on Tails > Settings > Update Bitcoin on Tails**. Make sure you still Trust this repository and it has retained a good reputation before doing so.

## How can I copy the block chain from a Bitcoin node I already have?
By copying the _blocks_ and _chainstate_ folders from your Bitcoin [data directory](https://github.com/bitcoin/bitcoin/blob/master/doc/files.md#data-directory-location). If you don't trust this node is not compromised, do NOT do this, wait for Bitcoin on Tails to synchronize.
...
## How do I make a backup Bitcoin on Tails?
Get a USB stick at least the same size  as your current Bitcoin on Tails then:
...
7. The device will be turned into an exact copy of your current Bitcoin on Tails.
...
## How should I handle my backup Bitcoin on Tails?
1. Keep it under lock and key and/or hidden and ideally in a tamper evident way.
   - If someone skilled tampers with your Bitcoin on Tails _**and** you use it without noticing_ they could monitor your activity or steal your bitcoins.
...
3. Make your backup Bitcoin on Tails look different from your current Bitcoin on Tails.
4. We recommend using the same passphrase as your current Tails so it is easier to remember.
5. Update or create a new backup Bitcoin on Tails at least every 6 months, more often without A/C.
6. You can use a third USB stick to create a new backup Bitcoin on Tails to quickly replace an off-site backup Bitcoin on Tails.
